...
angular.module('ui.grid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui-grid/pagination',
   "<div class=\"stat-data-group-container\"> \n" +
       "<div class=\"ui-grid-pager-panel\" ui-grid-pager ng-show=\"grid.options.enablePaginationControls\"> \n" +
            "<div class=\"ui-grid-pager-container\"> \n" +
                "<div class=\"ui-grid-pager-control\"> \n" +
                    "<div class=\"input-number-dec-controls\"> \n" +
                        "<button type=\"button\" ng-click=\"paginationApi.seek(1)\" ng-disabled=\"cantPageBackward()\"> \n" +
                            "<span class=\"ui-grid-button-first\"><i class=\"fa fa-angle-double-left \"></i></span> \n" +
                        "</button> \n" +
                        "<button type=\"button\" ng-click=\"paginationApi.previousPage()\" ng-disabled=\"cantPageBackward()\"> \n" +
                            "<span class=\"ui-grid-button-prev\"><i class=\"fa fa-angle-left \"></i></span> \n" +
                        "</button> \n" +
                    "</div> \n" +
                    "<div class=\"input-number-inc-controls\"> \n" +
                        "<button type=\"button\" ng-click=\"paginationApi.nextPage()\" ng-disabled=\"cantPageForward()\"> \n" +
                            "<span class=\"ui-grid-button-next\"><i class=\"fa fa-angle-right \"></i></span> \n" +
                        "</button> \n" +
                        "<button type=\"button\" ng-click=\"paginationApi.seek(paginationApi.getTotalPages())\" ng-disabled=\"cantPageToLast()\"> \n" +
                            "<span class=\"ui-grid-button-last\"><i class=\"fa fa-angle-double-right \"></i></span> \n" +
                        "</button> \n" +
                    "</div> \n" +
                "</div> \n" +
                 "<lla-input-number max=\"{{ paginationApi.getTotalPages() }}\" min=\"1\" current-number=\"grid.options.paginationCurrentPage\" state-changed=\"\" /></lla-input-number> \n" +
                ...
                "<div class=\"ui-grid-pager-row-count-picker\"> \n" +
                    "<ui-select ng-model=\"grid.options.paginationPageSize\" \n" +
                        "theme=\"bootstrap\" \n" +
                        "ng-disabled=\"disabled\" \n" +
                        "on-select=\"\"> \n" +
                        "<ui-select-match placeholder=\"\">{{$select.selected.value}}</ui-select-match> \n" +
                        "<ui-select-choices repeat=\"o.value as o in grid.options.paginationPageSizes | filter: $select.search\"> \n" +
                        "<div ng-bind-html=\"o.value | highlight: $select.search\"></div> \n" +
                        "</ui-select-choices> \n" +
                    "</ui-select> \n" +
                "</div> \n" +
                "<span class=\"ui-grid-pager-row-count-label hidden-xs\">&nbsp;{{sizesLabel}} {{grid.options.paginationPageSize.value}}</span> \n" +
            "</div> \n" +
